...
public class login extends javax.swing.JFrame {
    ...
    public login(JButton btiniciarsesion, JButton btregistrarse, JLabel jLabel1, JLabel jLabel2, JLabel jLabel3, JLabel jLabel4, JLabel jLabel5, JLabel jLabel6, JPasswordField txtcontraingreso, JTextField txtusuarioingreso) throws HeadlessException {
    ...
    public login(JButton btiniciarsesion, JButton btregistrarse, JLabel jLabel1, JLabel jLabel2, JLabel jLabel3, JLabel jLabel4, JLabel jLabel5, JLabel jLabel6, JPasswordField txtcontraingreso, JTextField txtusuarioingreso, GraphicsConfiguration gc) {
        super(gc);
        this.btiniciarsesion = btiniciarsesion;
        this.btregistrarse = btregistrarse;
        this.jLabel1 = jLabel1;
    ...
    public login(JButton btiniciarsesion, JButton btregistrarse, JLabel jLabel1, JLabel jLabel2, JLabel jLabel3, JLabel jLabel4, JLabel jLabel5, JLabel jLabel6, JPasswordField txtcontraingreso, JTextField txtusuarioingreso, String title) throws HeadlessException {
        super(title);
        this.btiniciarsesion = btiniciarsesion;
        this.btregistrarse = btregistrarse;
        this.jLabel1 = jLabel1;
    ...
    public login(JButton btiniciarsesion, JButton btregistrarse, JLabel jLabel1, JLabel jLabel2, JLabel jLabel3, JLabel jLabel4, JLabel jLabel5, JLabel jLabel6, JPasswordField txtcontraingreso, JTextField txtusuarioingreso, String title, GraphicsConfiguration gc) {
        super(title, gc);
        this.btiniciarsesion = btiniciarsesion;
        this.btregistrarse = btregistrarse;
        this.jLabel1 = jLabel1;
